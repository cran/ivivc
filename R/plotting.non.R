#Fitting with 1-Compartment PK Model:  1-Compartment menu -->iv route menu --> iv bolus route for "plot for nonlinear"
plotting.non <- function (InVVRefindex, fm, i, pick, xaxis, yaxis,
